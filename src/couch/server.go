...
func (this *Server) GetAllDatabases() ([]string, error) {
    ...
    var ret = util.MapSliceString(data)
...
func (this *Server) GetStats(path string) (map[string]map[string]map[string]interface{}, error) {
    ...
    var ret = make(map[string]map[string]map[string]interface{})
...
func (this *Server) GetUuids(count int) ([]string, error) {
    ...
    var ret = util.MapSliceString(count)
...
func (this *Server) SetConfig(section, key, value string) (string, error) {
    ...
    data, err := this.Client.Put("/_config/"+ section +"/"+ key, nil, value, nil).GetBodyData(nil)
    if err != nil {
        return "", err
    }
...
func (this *Server) RemoveConfig(section, key string) (string, error) {
    ...
    data, err := this.Client.Delete("/_config/"+ section +"/"+ key, nil, nil).GetBodyData(nil)
    if err != nil {
        return "", err
    }
